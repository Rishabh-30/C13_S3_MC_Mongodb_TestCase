...
import org.niit.C13_S3_MC_Mongodb.domain.Artist;
...
public class TrackServiceImplTest {
    ...
    @Test
    public void saveTrack() throws TrackAlreadyExistExcepion {
    ...
    public void returnTrackFailure(){
        when(trackRepository.findById(track1.getTrackId())).thenReturn(Optional.ofNullable(track1));
        assertThrows(TrackAlreadyExistExcepion.class,()->trackService.saveTrack(track1));
